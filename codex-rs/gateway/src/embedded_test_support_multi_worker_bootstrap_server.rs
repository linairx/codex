...
pub(crate) async fn start_mock_remote_multi_connection_bootstrap_setup_server(
                ...
                loop {
                    ...
                    let result = match request.method.as_str() {
                        ...
                        "config/read" => {
                            ...
                            let config_cwd =
                                if requested_cwd.is_some_and(|cwd| cwd.starts_with(unique_cwd)) {
                                    unique_cwd
                                } else {
                                    shared_cwd
                                };
                        ...
                        "plugin/list" => bootstrap_setup_plugin_list_json(worker_label, unique_cwd),
                        ...
                        "fuzzyFileSearch" => multi_worker_fuzzy_file_search_response(worker_label),
                        "command/exec" => {
                                ...
                                JSONRPCMessage::Notification(
                                    codex_app_server_protocol::JSONRPCNotification {
                                        ...
                                        params: Some(serde_json::json!({
                                            ...
                                            "stream": "stdout",
                                            "deltaBase64": "d29ya2VyLWEtY29tbWFuZA==",
                                            "capReached": false,
                                        })),
                                    },
                                ),
