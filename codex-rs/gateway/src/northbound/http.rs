...
mod tests {
        ...
        let app = router(
            Arc::new(FakeRuntime {
                health_response: Some(GatewayHealthResponse {
                    ...
                    remote_unlabeled_account_workers: Some(vec![
    ...
    #[tokio::test]
    async fn health_route_serializes_project_route_selection_and_mixed_project_worker_routes() {
        struct ProjectRouteHealthRuntime;
            ...
            fn health(&self) -> GatewayHealthResponse {
                GatewayHealthResponse {
                    ...
                    v2_connections: GatewayV2ConnectionHealth {
                        ...
                        last_project_worker_route_selected_project_id: Some(
                            "project-a".to_string(),
                        ),
                        last_project_worker_route_selected_thread_id: Some("thread-a".to_string()),
                        last_project_worker_route_selected_account_id: Some("acct-c".to_string()),
        ...
        let body: serde_json::Value =
            serde_json::from_slice(&body).expect("health response should be JSON");
        assert_eq!(body["v2Connections"]["projectWorkerRouteSelectionCount"], 3);
        assert_eq!(
            body["v2Connections"]["projectWorkerRouteSelectionWorkerCounts"],
            serde_json::json!([{
                "workerId": 3,
                "projectWorkerRouteSelectionCount": 3,
            }])
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedWorkerId"],
            3
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedTenantId"],
            "tenant-a"
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedProjectId"],
            "project-a"
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedThreadId"],
            "thread-a"
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedAccountId"],
            "acct-c"
        );
        assert_eq!(
            body["v2Connections"]["lastProjectWorkerRouteSelectedAt"],
            1710000002
        );
        assert_eq!(
            body["projectWorkerRoutes"],
    ...
    #[tokio::test]
    async fn health_route_marks_ineligible_project_worker_routes() {
        struct ProjectRouteHealthRuntime;
            ...
            fn health(&self) -> GatewayHealthResponse {
                GatewayHealthResponse {
                    ...
                    v2_connections: GatewayV2ConnectionHealth {
                        ...
                        last_account_capacity_event: Some(
                            "active_thread_handoff_failure".to_string(),
                        ),
                        ...
                        last_forwarded_notification_method: Some(
                        ...
                        protocol_violation_counts: vec![
                            crate::api::GatewayV2ProtocolViolationCounts {
                        ...
                        connection_outcome_counts: vec![
                            crate::api::GatewayV2ConnectionOutcomeCounts {
                                outcome: "client_send_timed_out".to_string(),
                                count: 2,
                            },
                        ],
