...
pub(crate) fn login_completed_notifications_are_treated_as_deduplicated_connection_state() {
    ...
    assert_eq!(
        super::super::super::should_deduplicate_connection_notification(&notification),
        true
    );
}
...
pub(crate) fn forwarded_connection_notification_dedupe_remembers_interleaved_payloads() {
    ...
    assert!(
        super::super::super::forwarded_connection_notification_duplicate(
    ...
    super::super::super::record_forwarded_connection_notification(
...
pub(crate) fn forwarded_connection_notification_dedupe_bounds_payload_history() {
    ...
    for index in 0..=super::super::super::MAX_FORWARDED_CONNECTION_NOTIFICATION_PAYLOADS_PER_METHOD
    {
        super::super::super::record_forwarded_connection_notification(
            &mut forwarded_connection_notifications,
            Some(index),
    ...
    let newest_index =
        super::super::super::MAX_FORWARDED_CONNECTION_NOTIFICATION_PAYLOADS_PER_METHOD;
    ...
    assert!(
        super::super::super::forwarded_connection_notification_duplicate(
            &forwarded_connection_notifications,
            Some(
                super::super::super::MAX_FORWARDED_CONNECTION_NOTIFICATION_PAYLOADS_PER_METHOD + 1
            ),
            &oldest_notice,
        )
        .is_none()
...
pub(crate) async fn unavailable_worker_route_diagnostics_marks_backoff_workers() {
    ...
    assert_eq!(
        ...
        vec![super::super::super::UnavailableWorkerRouteDiagnostics {
            worker_id: 1,
            websocket_url: "ws://worker-b.invalid".to_string(),
