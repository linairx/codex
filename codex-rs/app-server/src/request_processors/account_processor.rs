...
impl AccountRequestProcessor {
    ...
    async fn login_chatgpt_v2(
        ...
        let result = self
            .login_chatgpt_response(codex_streamlined_login, callback_port, login_success_page)
            .await;
        self.outgoing.send_result(request_id, result).await;
    }
    ...
    async fn login_chatgpt_response(
        ...
        let opts = self
            .login_chatgpt_common(codex_streamlined_login, callback_port, login_success_page)
            .await?;
