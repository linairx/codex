...
- dedicated northbound multi-worker tests now also verify that degraded
  ...
  logs with scope plus available, unavailable, and reconnect-backoff worker
  ids when the gateway intentionally serves the surviving workers' partial
  thread view
